...
public class AuthorizationServerConfig  extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory()
		  .withClient("angular")
		  .secret("$2a$10$T7r1YWKH7Wz4haUXdjgLee9TFENRsBPfgigsGQKlneyadWiJ7yLjS") // @ngul@r0
		  .scopes("read", "write")
		  ...
		  .and()
			.withClient("mobile")
			.secret(passwordEncoder.encode("$2a$10$x/WquF1GZYtcBSzn5mZ6g.7Gzz5KkJQKvUD4f5isuNK.2Vm8BZkR2")) // m0b1l30
			.scopes("read")
			.authorizedGrantTypes("password", "refresh_token")
			.accessTokenValiditySeconds(1801)
		    .refreshTokenValiditySeconds(3600*24);
